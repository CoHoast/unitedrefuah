  ...
  return (
    <section className="relative pt-24 pb-16 sm:pt-32 sm:pb-24 overflow-hidden">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        {/* Stats */}
        <div className="mt-20 grid grid-cols-2 lg:grid-cols-4 gap-8 max-w-4xl mx-auto lg:max-w-none">
          <div className="text-center p-6 rounded-2xl bg-card border border-border">
            <div className="text-3xl sm:text-4xl font-bold text-primary">60%</div>
            <div className="text-sm text-muted-foreground mt-1">Average Savings vs Traditional Insurance</div>
          </div>
          <div className="text-center p-6 rounded-2xl bg-card border border-border">
            <div className="text-3xl sm:text-4xl font-bold text-primary">5,000+</div>
            <div className="text-sm text-muted-foreground mt-1">Member Families</div>
          </div>
          <div className="text-center p-6 rounded-2xl bg-card border border-border">
            <div className="text-3xl sm:text-4xl font-bold text-primary">$50M+</div>
            <div className="text-sm text-muted-foreground mt-1">Medical Bills Shared</div>
          </div>
          <div className="text-center p-6 rounded-2xl bg-card border border-border">
            <div className="text-3xl sm:text-4xl font-bold text-primary">98%</div>
            <div className="text-sm text-muted-foreground mt-1">Member Satisfaction</div>
          </div>
        </div>
      </div>
    </section>
