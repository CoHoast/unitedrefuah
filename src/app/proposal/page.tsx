        ...
        <section className="min-h-screen flex items-center justify-center px-6">
          <div className="max-w-4xl mx-auto text-center">
            <div className="mb-8">
              ...
              />
              <Badge className="bg-cyan-400/20 text-cyan-300 border-cyan-400/30 mb-6">
            ...
            <h1 className="text-4xl sm:text-5xl md:text-6xl font-bold text-white mb-6">
              ...
              <span className="block text-cyan-400 mt-2">Complete Digital Transformation</span>
            </h1>
        ...
        <section className="min-h-screen py-20 px-6">
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              <Badge className="bg-cyan-400/20 text-cyan-300 border-cyan-400/30 mb-4">
                Interactive Demo
              </Badge>
                  ...
                  <CardContent className="p-6">
                    <div className="flex items-start gap-4 mb-4">
                      ...
                      <div>
                        ...
                        <p className="text-slate-400 text-sm">{stop.description}</p>
                      </div>
                    </div>
                    ...
                    <ul className="space-y-2 mb-6">
                      {stop.features.map((feature) => (
                        <li key={feature} className="flex items-center gap-2 text-sm text-slate-300">
                          <svg className="w-4 h-4 text-cyan-400 flex-shrink-0" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
                    ...
                    <Link href={stop.link} target="_blank">
                      <Button 
                        className="w-full bg-slate-700 hover:bg-cyan-600 group-hover:bg-cyan-600 transition-colors"
                      >
                        {stop.linkText}
                      </Button>
                    </Link>
            ...
            <div className="flex justify-between mt-12">
              <Button variant="ghost" onClick={prevSection} className="text-slate-400 hover:text-white">
                ← Back
              </Button>
              <Button onClick={nextSection} className="bg-cyan-500 hover:bg-cyan-400 text-slate-900">
                SEO & Optimizations →
              </Button>
            </div>
          </div>
          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
              {optimizations.map((opt) => (
                <Card key={opt.title} className="bg-slate-800/50 border-slate-700">
                  <CardContent className="p-6">
              ...
              <CardContent className="p-8">
                <div className="grid md:grid-cols-3 gap-8 text-center">
                  <div>
                    ...
                    <div className="text-slate-400">Page Load Time</div>
                  </div>
                  <div>
                    <div className="text-4xl font-bold text-green-400 mb-2">95+</div>
                    <div className="text-slate-400">Google PageSpeed Score</div>
                  </div>
                  <div>
                ...
                >
                  {pkg.popular && (
                    <div className="absolute -top-3 left-1/2 -translate-x-1/2">
                      <Badge className="bg-cyan-500 text-slate-900">Recommended</Badge>
                    </div>
                  )}
                  <CardContent className="p-8">
                    ...
                    <div className="text-sm text-slate-500 mb-6">
                      Timeline: <span className="text-slate-300">{pkg.timeline}</span>
                    </div>

                    <ul className="space-y-3 mb-8">
                      {pkg.features.map((feature) => (
                        <li key={feature} className="flex items-start gap-2 text-slate-300">
                          <svg className="w-5 h-5 text-cyan-400 flex-shrink-0 mt-0.5" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
                            <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 12.75l6 6 9-13.5" />
                          </svg>
                          {feature}
                        </li>
      ...
      {currentSection === 4 && (
        <section className="min-h-screen flex items-center justify-center py-20 px-6">
          <div className="max-w-3xl mx-auto text-center">
            <div className="w-20 h-20 rounded-full bg-gradient-to-r from-cyan-500 to-blue-500 flex items-center justify-center mx-auto mb-8">
            ...
            <div className="bg-slate-800/50 rounded-2xl p-8 mb-8 text-left">
              ...
              <ol className="space-y-4">
                <li className="flex items-start gap-4">
                  <span className="w-8 h-8 rounded-full bg-cyan-500/20 text-cyan-400 flex items-center justify-center flex-shrink-0 font-bold">1</span>
                  <div>
                    <p className="text-white font-medium">Schedule a call</p>
                    <p className="text-slate-400 text-sm">Review the demo together and answer any questions</p>
                  </div>
                </li>
                <li className="flex items-start gap-4">
                  <span className="w-8 h-8 rounded-full bg-cyan-500/20 text-cyan-400 flex items-center justify-center flex-shrink-0 font-bold">2</span>
                  <div>
                    <p className="text-white font-medium">Discuss integrations</p>
                    <p className="text-slate-400 text-sm">Map out your existing systems and API requirements</p>
                  </div>
                </li>
                <li className="flex items-start gap-4">
                  <span className="w-8 h-8 rounded-full bg-cyan-500/20 text-cyan-400 flex items-center justify-center flex-shrink-0 font-bold">3</span>
                  <div>
                    <p className="text-white font-medium">Finalize scope & kick off</p>
                    <p className="text-slate-400 text-sm">Lock in timeline and begin development</p>
                  </div>
                </li>
              </ol>
            </div>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
              <Button size="lg" className="bg-cyan-500 hover:bg-cyan-400 text-slate-900 font-semibold px-8">
